            ...
            {provider.workingHours && (
              <div className="mb-6 p-4 bg-gray-50 rounded-xl border border-gray-100">
                <div className="flex items-center gap-2 mb-2">
                  <Clock className="w-4 h-4 text-[#6d0ef1]" />
                  <h4 className="font-bold text-gray-900 text-sm">Darbo laikas</h4>
                </div>
                <p className="text-sm text-gray-700">{provider.workingHours}</p>
              </div>
            )}
