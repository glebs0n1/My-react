...
const PetDetail: React.FC = () => {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-screen text-gray-500 text-lg pt-16">
        Kraunama... 🐾
      </div>
    );
  }
  ...
  return (
    <>
      <div className="max-w-7xl mx-auto px-4 lg:px-8 py-16 lg:py-24 pt-24">
